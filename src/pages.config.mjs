...
export const pages = [
  ...
  },
  {
    ...
    description: 'PesaFlow (a live Kenya-first budgeting app), TrustGiving (a church finance system with audit-grade integrity), SafeReport, a biometric student portal, and other work.',
